...
function Lighthouse(props) {
  const group = useRef();
  const { nodes, materials } = useGLTF('/lighthouse/scene.gltf');
  return (
    <group ref={group} {...props} dispose={null} rotation={[0, Math.PI, 0]}>
      ...
      <group position={[27.86, 465.89, -7.8]} rotation={[0.09, 0.35, -0.03]}>
        <mesh
      ...
      <group position={[318.39, 79.72, 7.03]} rotation={[0, Math.PI / 2, 0]}>
